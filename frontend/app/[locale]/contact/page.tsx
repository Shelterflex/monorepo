    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        if (apiError.details) {
          ...
          setError(err.message || t('form.failedGeneric'))
        }
      } else {
          ...
          <div className="grid gap-8 lg:grid-cols-2">
              ...
              <Card className="border-3 border-foreground p-4 shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] md:p-6">
                ...
                {submitted && (
                  <div className="mb-6 border-3 border-secondary bg-secondary/10 p-4">
                    <p className="font-bold text-secondary">{t("form.success")}</p>
                    <p className="text-sm text-muted-foreground mt-1">{t("form.successDesc")}</p>
                  </div>
                )}
                ...
                {error && (
                  <div className="mb-6 border-3 border-destructive bg-destructive/10 p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-bold text-destructive">{t("form.failed")}</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  <div>
                    <label htmlFor="contact-name" className="mb-2 block text-sm font-bold">{t("form.name")}</label>
                    <Input
                      id="contact-name"
                      type="text"
                      name="name"
                  ...
                  <div>
                    <label htmlFor="contact-email" className="mb-2 block text-sm font-bold">{t("form.email")}</label>
                    <Input
                      id="contact-email"
                      type="email"
                      name="email"
                  ...
                  <div>
                    <label htmlFor="contact-phone" className="mb-2 block text-sm font-bold">{t("form.phone")}</label>
                    <Input
                      id="contact-phone"
                      type="tel"
                      name="phone"
                  ...
                  <div>
                    <label htmlFor="contact-subject" className="mb-2 block text-sm font-bold">{t("form.subject")}</label>
                    <Input
                      id="contact-subject"
                      type="text"
                      name="subject"
                  ...
                  <div>
                    <label htmlFor="contact-message" className="mb-2 block text-sm font-bold">{t("form.message")}</label>
                    <textarea
                      id="contact-message"
                      name="message"
            ...
            <div className="space-y-6">
              <Card className="border-3 border-foreground p-4 shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] md:p-6">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-bold">{t("info.email")}</h3>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-bold">{t("info.phone")}</h3>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-bold">{t("info.address")}</h3>
              ...
              <Card className="border-3 border-foreground bg-muted p-4 shadow-[4px_4px_0px_0px_rgba(26,26,26,1)] md:p-6">
                ...
                <p className="text-xs text-muted-foreground">{t("info.averageResponse")}</p>
              </Card>
