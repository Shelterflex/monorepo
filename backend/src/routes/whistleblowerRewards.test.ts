...
import { createWhistleblowerRewardsRouter } from './whistleblowerRewards.js'
...
describe('Whistleblower Rewards Routes', () => {
  ...
  beforeEach(() => {
    ...
    app.use('/api/whistleblower-rewards', createWhistleblowerRewardsRouter(mockAdapter))
